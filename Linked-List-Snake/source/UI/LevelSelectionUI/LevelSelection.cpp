...
namespace UI
{
    ...
    namespace LevelSelection
    {
        ...
        void LevelSelectionUIController::levelOneButtonCallback()
        {
            ...
            ServiceLocator::getInstance()->GetLevelServices()->SetCurrentLevel(Level::LevelNumber::ONE);
        }
        ...
        void LevelSelectionUIController::levelTwoButtonCallback()
        {
            ServiceLocator::getInstance()->getSoundService()->playSound(SoundType::BUTTON_CLICK);
            GameService::setGameState(GameState::LINKED_LIST_SELECTION);
            ServiceLocator::getInstance()->GetLevelServices()->SetCurrentLevel(Level::LevelNumber::TWO);
        }
